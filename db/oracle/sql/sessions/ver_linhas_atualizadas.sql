...
-- Description: Verifica as linhas atualizadas por uma sessao especifica - Script do Gil
...
and a.SQL_ID='gq9srgrgs0rtq'
and  to_char(s.LOGON_TIME,'yyyymmddhh24mi') > (select to_char(sysdate-2,'yyyymmdd')||1200 from dual) -- 12:00 dia anterior
AND s.logon_time between to_date('09/01/2025 21:00:00','dd/mm/yyyy hh24:mi:ss') and to_date('09/01/2025 22:20:00','dd/mm/yyyy hh24:mi:ss')
