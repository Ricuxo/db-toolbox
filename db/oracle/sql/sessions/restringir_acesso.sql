...
select SESSION_USER,HOST,OS_USER,TERMINAL,MODULE,IP_ADDRESS from v$session where username='HR';
...
--- TODO
--- COLOCAR DATA NAS TABELAS


CREATE TABLE TB_BLOCKED_LOGON
    (
    SESSION_USER VARCHAR2(50) NOT NULL,
    HOST VARCHAR2(50),
    OS_USER VARCHAR2(50),
...
CREATE INDEX I1_BLOCKED_LOGON ON TB_BLOCKED_LOGON(SESSION_USER) TABLESPACE USERS;
  ...
  THEN
    ...
    CASE V_GLOBAL_NAME
      WHEN 'ORCL' THEN
        ...
        ELSE
          --NULL;
          INSERT INTO TB_BLOCKED_LOGON VALUES (V_SESSION_USER, V_HOST, V_OS_USER, V_TERMINAL, V_MODULE, V_IP_ADDRESS);
          COMMIT;
          RAISE_APPLICATION_ERROR(-20000, 'YOU ARE NOT AUTHORIZED TO LOGIN WITH THIS USERNAME. PLEASE CONTACT YOUR DBA.');          
        END IF;
      ELSE
