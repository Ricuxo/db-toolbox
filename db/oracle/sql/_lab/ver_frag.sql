...
TTITLE CENTER 'R E O R G - P R O G R A M' 
...
PROMPT
PROMPT
PROMPT ====***Apos o Rebuild todos os indices serao configurados para parallel degree 1====
PROMPT
SELECT degree, COUNT(1) "Total Indexes"
FROM dba_indexes
WHERE owner='&&v_owner'
GROUP BY degree;
...
PROMPT
PROMPT
PROMPT ====PARAMETROS DE PARALELISMO====
show parameter cpu
PROMPT
PROMPT