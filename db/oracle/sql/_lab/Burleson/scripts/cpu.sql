/*  */
rem cpu.sql
rem 7/nov  Mike Ault Initial creation
rem
...
@title132 'SQL By CPU Usuage'
spool rep_out\&db\cpu
select * from 
(select sql_text,cpu_time/1000000000 cpu_time,elapsed_time/1000000000 elapsed_time, 
