prompt # 
prompt # Monitor de threshold para as tablespace.
prompt # 

set serveroutput on size 1000000
declare
cursor c1 is select a.tablespace_name, c.EXTENT_MANAGEMENT, c.ALLOCATION_TYPE, 
                    tot_alocado, tot_livre, trunc((1-(tot_livre/tot_alocado))*100) per_ocupado
...
begin
dbms_output.put_line('tablespace      ext_mgm    alloc_type              alocado                livre  ocup     threshold  est');
...
for r1 in c1 loop
    ...
    if    r1.tot_livre is null or r1.tot_livre < 100000 then
          ...
          dbms_output.put_line(rpad(r1.tablespace_name,15,' ')||' '||
                               rpad(r1.EXTENT_MANAGEMENT,10,' ')||' '||
                               rpad(r1.ALLOCATION_TYPE,10,' ')||' '||
