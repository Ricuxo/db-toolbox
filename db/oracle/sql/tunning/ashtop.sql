...
--     @ashtop session_state,event 1=1 "TIMESTAMP='2015-11-20 12:00:00'" "TIMESTAMP='2015-11-20 12:03:00'
--     @ashtop session_state,event 1=1 sysdate-1/24/12 sysdate
--     @ashtop session_state,event 1=1 sysdate-1/24/12 sysdate

--DEF 5MIN
--DEF HOUR
--
--     @ashtop session_state,evenT,username 1=1 &5min
--
--     @ashtop sql_id "event='db file scattered read'" &5min
--     @ashtop program "event='db file scattered read'" &5min
--     @ashtop module "event='db file scattered read'" &5min
--     @ashtop module,action "event='db file scattered read'" &5min
--
