-- -----------------------------------------------------------------------------------
-- File Name    : @tab_fts_plan.sql 
-- Author       : Henrique
-- Description  : Extrai os planos de execução de instruções SQL que estão realizando Full Table Scan. Retirado do Livro OWI
-- Call Syntax  : @tab_fts_plan.sql
--
