...
@awr_plan_2.sql -> verifica se o plano mudou... olhar a coluna AVG_ETIME, o menor valor é que será o melhor HASH
@plan_awr.sql -> gera o plano de execução da query para todos os sql_id
@create_sql_profile_awr.sql -> cria a profile para o melhor plano
